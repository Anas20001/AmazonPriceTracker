...
class GenerateReport:
    def __init__(self, file_name, filters, base_links, currency, data):
        self.data = data
    ...
    def get_best_item(self):
        try:
                ####### how to sort list of dictionaries by key 
...
class AmazonAPI:
    ...
    def  run(self):
        ...
        print(f"Looking {self.search_term} products...")
        links = self.get_products_links()
        time.sleep(1)
        if not links:
            print("Stopped script.")
            return
        print(f"Got {len(links)} links ot products...")
    ...
    def get_products_info(self, links):
        ...
        products = []
        for asin in asins[:8]: ### min products if you want [:8]
    ...
    def get_price(self):
        ...
        try:
            ...
            try:
                ...
                print(e)
                print(f"Cant get price of a product - {self.driver.current_url}")
                return None
            return price     
